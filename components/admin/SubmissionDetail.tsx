  ...
  if (!submission) {
    return (
      <div className="text-center py-12">
        <p className="text-gray-600 text-lg">Submission not found.</p>
        <Link
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border-2 border-gray-200 rounded-lg p-8">
        <div className="mb-8 pb-6 border-b border-gray-200">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">{submission.name}</h1>
          <p className="text-lg text-gray-600">{submission.email}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* Step 2: The Vision */}
            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Project Vision</h2>
              <div className="space-y-4">
                ...
                {submission.target_audience && (
                  <div>
                    ...
                    <p className="text-gray-600 whitespace-pre-wrap">{submission.target_audience}</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Timeline & Budget</h2>
              <div className="space-y-4">
                {submission.timeline && (
                  <div>
                ...
                {submission.urgency && (
                  <div>
                    <p className="text-sm font-semibold text-gray-700 mb-1">Urgency</p>
                    <p className="text-gray-600">{submission.urgency}</p>
                  </div>
                )}
                {submission.budget && (
                  <div>
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Business Story</h2>
              <div className="space-y-4">
                ...
                {submission.unique_value && (
                  <div>
                    <p className="text-sm font-semibold text-gray-700 mb-1">Unique Value Proposition</p>
            ...
            <div>
              ...
              <div className="space-y-4">
                {submission.has_content && (
                  <div>
                    <p className="text-sm font-semibold text-gray-700 mb-1">Has Content</p>
                    <p className="text-gray-600">{submission.has_content}</p>
                  </div>
                )}
                {submission.content_description && (
                  <div>
                    <p className="text-sm font-semibold text-gray-700 mb-1">Content Description</p>
                    <p className="text-gray-600 whitespace-pre-wrap">{submission.content_description}</p>
                  </div>
                )}
                {submission.preferred_style && (
                  <div>
                    <p className="text-sm font-semibold text-gray-700 mb-1">Preferred Style</p>
                    <p className="text-gray-600">{submission.preferred_style}</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                {submission.color_preferences && (
                  <div>
                    <p className="text-sm font-semibold text-gray-700 mb-1">Color Preferences</p>
                    <p className="text-gray-600">{submission.color_preferences}</p>
                  </div>
                )}
                {submission.reference_sites && (
                  <div>
                    <p className="text-sm font-semibold text-gray-700 mb-1">Reference Sites</p>
                    <p className="text-gray-600 whitespace-pre-wrap">{submission.reference_sites}</p>
                  </div>
                )}
                {submission.brand_guidelines && (
                  <div>
                    <p className="text-sm font-semibold text-gray-700 mb-1">Brand Guidelines</p>
                    <p className="text-gray-600 whitespace-pre-wrap">{submission.brand_guidelines}</p>
                  </div>
                )}
              </div>
            </div>
            ...
            {/* Step 6: Features */}
            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Features & Requirements</h2>
              <div className="space-y-4">
                ...
                {submission.integrations && (
                  <div>
                    <p className="text-sm font-semibold text-gray-700 mb-1">Integrations</p>
                    <p className="text-gray-600 whitespace-pre-wrap">{submission.integrations}</p>
                  </div>
                )}
                {submission.special_requirements && (
                  <div>
                    <p className="text-sm font-semibold text-gray-700 mb-1">Special Requirements</p>
                    <p className="text-gray-600 whitespace-pre-wrap">{submission.special_requirements}</p>
                  </div>
                )}
              </div>
            </div>
