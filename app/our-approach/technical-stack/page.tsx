      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Core Technologies</h2>
            
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Next.js</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">TypeScript</h3>
                <p className="text-gray-700 dark:text-gray-300 mb-2">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Tailwind CSS</h3>
                <p className="text-gray-700 dark:text-gray-300 mb-2">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Why These Technologies?</h2>
            
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Performance</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">SEO-Friendly</h3>
                <p className="text-gray-700 dark:text-gray-300">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Maintainable</h3>
                <p className="text-gray-700 dark:text-gray-300">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Modern Standards</h3>
                <p className="text-gray-700 dark:text-gray-300">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">For Designers</h3>
                <p className="text-gray-700 dark:text-gray-300">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Deployment</h2>
