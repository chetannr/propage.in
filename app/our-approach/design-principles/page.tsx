        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">1. Purpose Over Decoration</h3>
                <p className="text-gray-700">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">2. Confidence Through Restraint</h3>
                <p className="text-gray-700">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">3. First Principles Thinking</h3>
                <p className="text-gray-700">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Visual Design</h2>
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Spacing</h3>
                <p className="text-gray-700 mb-2">
