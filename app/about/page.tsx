      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Our Story</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Our Expertise</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              Our design principles are inspired by the masters:
            </p>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-4 [&_li::marker]:mr-0">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Our Approach</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Why Choose Us</h2>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 [&_li::marker]:mr-0">
